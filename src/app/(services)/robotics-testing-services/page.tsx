...
import StructuredData, { createBreadcrumbSchema, roboticTestingSchema, } from "@/components/seo/StructuredData";

export const metadata: Metadata = {
  title:  "Robotic Process Automation Testing Services Company",

  description: "We are one of the best Robotic Process Automation Testing Services Companies in Mumbai. With expertise in testing Web applications and mobile apps..",
  keywords: [
...
export default function RoboticTestingPage() {
  const breadcrumbItems = [
    ...
    { name: "Robotic Testing Services", url: "https://testriq.com/robotics-testing-services" }
  ];
  return (
