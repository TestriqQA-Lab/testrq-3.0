...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title:
      "Complete Software Testing Guide - Best Practices, Types & Methodologies | Testriq",
    description:
      "Master software testing with our complete guide. Learn manual, automation, performance, and security testing best practices, tools, and methodologies.",
    images: [
      {
