...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: "https://www.testriq.com/pricing6",
    },
    openGraph: {
        ...
        url: "https://www.testriq.com/pricing6",
    }
};

const Pricing6Hero = dynamic(
    () => import("@/components/sections/Pricing6Hero"),
    { ssr: true, loading: () => <HeroLoader /> }
);

const Pricing6Cards = dynamic(
    () => import("@/components/sections/Pricing6Cards"),
    { ssr: true, loading: () => <ContentLoader /> }
);

export default function Pricing6Page() {
    const breadcrumbItems = [
        { name: "Home", url: "https://www.testriq.com/" },
        { name: "Pricing", url: "https://www.testriq.com/pricing6" },
    ];
