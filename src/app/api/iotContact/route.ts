...
export async function POST(request: NextRequest) {
  try {
    ...
    const formattedData: IoTContactFormData = {
      ...body,
      source: body.source || 'IoT Appliance Testing Services Page',
    };
...
async function storeInGoogleSheets(data: IoTContactFormData) {
  try {
    ...
    // Use IoT specific sheet tab
    const sheetName = 'IoT';
    const range = `${sheetName}!A:I`;

    // Check if IoT sheet exists and has headers
    try {
      ...
      if (!headerResponse.data.values || headerResponse.data.values.length === 0) {
        ...
        const headers = ['Timestamp', 'Full Name', 'Business Email', 'Business Phone', 'Company Name', 'IoT Solution Type', 'Testing Requirements', 'Project Details', 'Source'];
    ...
    console.log('IoT data stored in Google Sheets successfully');
  } catch (error) {
...
async function sendProfessionalNotification(data: IoTContactFormData) {
  try {
    ...
    const mailOptions: nodemailer.SendMailOptions = {
      from: `"Testriq IoT Contact Form" <${FROM_EMAIL}>`,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="text-align: center; padding: 20px; background: #f3f4f6; color: white; border-radius: 8px 8px 0 0;">
            ...
            <h2 style="margin: 0; font-size: 24px; color: #25a8e0;">New IoT Contact Form Submission</h2>
          </div>
          ...
          <div style="background-color: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0;">
            ...
            <p><strong>Source:</strong> ${data.source || 'IoT Appliance Testing Services Page'}</p>
          </div>
         ...
         <div style="background-color: #f3f4f6; padding: 25px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb; border-top: none;">
            <div style="text-align: center; color: #6b7280; font-size: 14px; line-height: 1.5;">
              ...
              <p style="margin: 0 0 5px 0;">This email was sent from the Testriq QA Lab IoT contact form.</p>
...
async function sendClientConfirmation(data: IoTContactFormData) {
  try {
    ...
    const mailOptions = {
      ...
      subject: 'Thank you for contacting Testriq QA Lab - IoT Testing Services',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
          ...
          <div style="padding: 30px; background-color: #ffffff; border: 1px solid #e5e7eb; border-top: none;">
            ...
            <p style="line-height: 1.6; margin-bottom: 20px;">
              Thank you for reaching out to Testriq QA Lab regarding our IoT testing services. We have received your inquiry and appreciate your interest in securing your IoT ecosystem.
            </p>
            ...
            <div style="background-color: #f0f9ff; padding: 20px; border-radius: 8px; border-left: 4px solid #2563eb; margin: 25px 0;">
              ...
              <div style="display: grid; gap: 8px;">
                ...
                <p style="margin: 0;"><strong>IoT Solution Type:</strong> ${data.iotSolutionType}</p>
            ...
            <div style="background-color: #dcfce7; padding: 20px; border-radius: 8px; margin: 25px 0;">
              ...
              <p style="margin: 0; line-height: 1.6;">
                Our IoT testing specialists will review your inquiry and get back to you <strong>within 2 hours</strong> during business hours (Monday-Friday, 9 AM - 6 PM IST) with a customized testing strategy for your IoT solution.
              </p>
            </div>
            ...
            <p style="line-height: 1.6; margin-bottom: 30px;">
              We look forward to helping you achieve secure connectivity, regulatory compliance, and optimized device performance through comprehensive IoT testing.
            </p>
