...
import { FaRobot, FaCogs, FaRocket, FaBolt, FaMobile, FaDesktop, FaCloud, FaCode } from "react-icons/fa";
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6 pt-8">
              ...
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-indigo-600">80%</div>
                <div className="text-sm text-gray-600">Time Reduction</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-blue-600">1,200+</div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Automation Control Center</h3>
                </div>
                <span className="text-sm text-purple-600 font-medium">Running</span>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-indigo-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm font-medium text-indigo-900">Execute</div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm font-medium text-blue-900">Report</div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-purple-600">24 Running</div>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-indigo-600">2h 15m</div>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg">
              ...
              <div className="mb-4">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-purple-600 font-medium">72% Complete</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div className="bg-gradient-to-r from-purple-600 to-indigo-600 h-3 rounded-full" style={{width: '72%'}}></div>
                </div>
              </div>
