              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <span className="text-purple-300 font-semibold flex items-center gap-2 group">
                      {option.text}
                    </span>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {expertiseAreas.map((area, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <area.icon className="w-5 h-5 text-purple-300 mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold text-white text-sm">{area.title}</h4>
                      <p className="text-blue-100 text-xs">{area.description}</p>
                    </div>
                  </div>
                ))}
              </div>
