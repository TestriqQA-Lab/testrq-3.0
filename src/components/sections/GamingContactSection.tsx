  ...
  const contactOptions = [
    {
      ...
      description: "Book a free 30-minute consultation with our gaming testing experts",
      action: "Schedule Now",
    ...
    },
    {
      ...
      description: "Get immediate answers from our gaming testing specialists",
      action: "Call Now",
    ...
    },
    {
      ...
      description: "Get a detailed proposal and quote for your gaming testing needs",
      action: "Get Quote",
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl">
            <div className="mb-8">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Get Your Free Gaming Testing Assessment</h3>
              <p className="text-gray-600">Fill out this form and our gaming testing experts will contact you within 24 hours.</p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Company/Studio Name *</label>
                <input 
                  type="text" 
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[theme(color.brand.blue)] focus:border-transparent outline-none transition-all"
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    <span className="ml-2 text-gray-700">iOS (iPhone/iPad)</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" className="rounded border-gray-300 text-[theme(color.brand.blue)] focus:ring-[theme(color.brand.blue)]" />
              ...
              <button className="w-full bg-gradient-to-r from-[theme(color.brand.blue)] to-purple-600 text-white py-4 px-8 rounded-2xl font-semibold text-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 group">
                Get Free Assessment
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Our Gaming Expertise</h3>
              <div className="space-y-4">
                {expertiseAreas.map((area, index) => (
                  <div key={index} className="flex items-start gap-4 p-4 bg-gray-50 rounded-2xl">
                    <div className="w-10 h-10 bg-gradient-to-r from-[theme(color.brand.blue)] to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div className="bg-gradient-to-r from-[theme(color.brand.blue)] to-purple-600 rounded-3xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-6">Why Choose Testriq for Gaming Testing?</h3>
              <div className="space-y-4">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Gaming Hotline</div>
                    <div className="text-gray-600">+1 (555) 123-GAMES</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Gaming Team</div>
                    <div className="text-gray-600">gaming@testriq.com</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
        ...
        <div className="bg-gradient-to-r from-[theme(color.brand.blue)] to-purple-600 rounded-3xl p-8 md:p-12 text-white text-center">
          <div className="max-w-3xl mx-auto">
            <h3 className="text-3xl font-bold mb-4">Start Your Gaming Success Story Today</h3>
            <p className="text-blue-100 mb-8 text-lg">
              Join 500+ game developers who trust Testriq for comprehensive gaming testing 
              and successful game launches across all platforms.
            </p>
