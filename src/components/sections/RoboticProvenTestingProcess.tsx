  ...
  const processSteps = [
    {
      ...
      description: "Comprehensive analysis of robotic systems, specifications, and safety requirements to create a detailed testing strategy.",
    ...
    },
    {
      ...
      description: "Setting up controlled testing environments with safety protocols and monitoring systems for comprehensive robotic testing.",
    ...
    },
    {
      ...
      description: "Executing comprehensive functional tests and critical safety validations to ensure robotic systems meet all requirements.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Our Proven Robotic Testing <span className="text-brand-blue">Process</span>
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Our systematic approach ensures comprehensive robotic testing coverage, delivering reliable, 
            safe, and high-performance robotic systems for your applications.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Robotic Testing Workflow</h3>
            <p className="text-gray-600">Visualizing our comprehensive robotic testing methodology</p>
          </div>
