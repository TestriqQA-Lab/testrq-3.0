  ...
  const toolCategories = [
    {
      ...
      tools: [
        { name: "Selenium WebDriver", description: "Fast automated web testing for rapid feedback cycles" },
        { name: "Cypress", description: "Modern end-to-end testing with real-time browser testing" },
        { name: "Playwright", description: "Cross-browser automation for comprehensive coverage" },
        { name: "TestCafe", description: "Node.js-based testing with no WebDriver dependencies" }
      ]
    },
    {
      title: "Agile CI/CD Integration",
      tools: [
        { name: "Jenkins", description: "Continuous integration for automated testing pipelines" },
        { name: "GitHub Actions", description: "Workflow automation integrated with development" },
        { name: "GitLab CI/CD", description: "Built-in continuous integration and deployment" },
        { name: "Azure DevOps", description: "End-to-end DevOps toolchain for rapid delivery" }
      ]
    },
    {
      title: "Performance Testing",
      tools: [
        { name: "JMeter", description: "Load testing for performance validation at scale" },
        { name: "K6", description: "Modern load testing for developer-centric workflows" },
        { name: "Artillery", description: "Modern performance testing toolkit for APIs" },
        { name: "WebPageTest", description: "Real-world performance testing and optimization" }
      ]
    },
    {
      title: "Mobile Testing",
      tools: [
        { name: "Appium", description: "Cross-platform mobile automation for iOS and Android" },
        { name: "Detox", description: "Gray box end-to-end testing for mobile apps" },
        { name: "Espresso", description: "Android UI testing framework for rapid feedback" },
        { name: "XCUITest", description: "iOS UI testing framework for native applications" }
      ]
    },
    {
      title: "API Testing",
      tools: [
        ...
        { name: "REST Assured", description: "Java-based REST API testing framework" },
        { name: "Newman", description: "Command-line collection runner for Postman" },
        { name: "Insomnia", description: "API client for REST and GraphQL testing" }
      ]
    },
    {
      title: "Monitoring & Analytics",
      tools: [
        { name: "Datadog", description: "Real-time monitoring and analytics platform" },
        ...
        { name: "LogRocket", description: "Frontend monitoring and session replay" }
      ]
    }
  ];
            ...
            <div key={categoryIndex} className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-6">
                {category.tools.map((tool, toolIndex) => (
                  <div key={toolIndex} className="bg-white p-4 rounded-lg border border-gray-100 hover:border-blue-200 transition-all duration-300 group">
