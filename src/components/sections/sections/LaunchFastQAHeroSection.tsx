...
import { FaRocket, FaCheckCircle, FaBolt, FaCode, FaMobile, FaDesktop, FaCloud } from "react-icons/fa";
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              ...
              Rapid testing cycles, agile integration, and continuous quality assurance 
              designed for startups and fast-moving development teams.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8">
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-blue-600">48hr</div>
                <div className="text-sm text-gray-600">Rapid Turnaround</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-green-600">99.5%</div>
                <div className="text-sm text-gray-600">Launch Success Rate</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-purple-600">300+</div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">LaunchFast QA Dashboard</h3>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-blue-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm font-medium text-blue-900">Development</div>
                ...
                <div className="bg-purple-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm font-medium text-purple-900">Testing</div>
                ...
                <div className="bg-green-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm font-medium text-green-900">Launch</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-green-600">94% Ready</div>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg">
                  <div className="text-xs text-gray-600">Test Coverage</div>
                  <div className="text-lg font-bold text-blue-600">Comprehensive</div>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg">
              ...
              <div className="mb-4">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-blue-600 font-medium">94% Complete</span>
                </div>
