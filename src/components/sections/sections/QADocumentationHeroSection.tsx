          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                Professional <span className="text-blue-600">QA Documentation</span> Services
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="inline-flex items-center px-8 py-4 bg-white text-purple-600 font-semibold rounded-lg border-2 border-purple-600 hover:bg-purple-50 transition-colors duration-200">
