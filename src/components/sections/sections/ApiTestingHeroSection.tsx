          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-3xl shadow-2xl border border-blue-200">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-green-500">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold text-gray-700">GET /users</span>
              ...
              <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-blue-500">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold text-gray-700">POST /auth</span>
              ...
              <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-purple-500">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold text-gray-700">PUT /data</span>
                  <span className="text-xs bg-purple-100 text-purple-800 px-2 py-1 rounded">200</span>
                </div>
              ...
              <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-orange-500">
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold text-gray-700">DELETE /item</span>
                  <span className="text-xs bg-orange-100 text-orange-800 px-2 py-1 rounded">204</span>
                </div>
            ...
            <div className="bg-white p-4 rounded-lg shadow-md">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-gray-700">API Test Suite</span>
                <span className="text-xs text-green-600 font-semibold">98% Passed</span>
              </div>
