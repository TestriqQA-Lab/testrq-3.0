...
const IoTReadyToEnsureQuality: React.FC = () => {
  return (
    <section className="bg-[theme(color.brand.blue)] py-16 px-8 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
          Ready to Ensure IoT Quality?
        </h2>
        <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
          Join 100+ companies who trust our IoT testing services. Get started with 
          a comprehensive IoT device assessment today and ensure your connected 
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <button className="flex items-center gap-2 py-3 px-8 bg-white text-[theme(color.brand.blue)] font-semibold text-lg rounded-md hover:bg-gray-100 transition-colors duration-300">
            <span>Start IoT Assessment</span>
...
export default IoTReadyToEnsureQuality;
