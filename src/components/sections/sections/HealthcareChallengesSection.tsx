  ...
  const challenges = [
    {
      ...
      problem: "Healthcare data breaches cost an average of $10.93 million per incident",
      impact: "Legal penalties, reputation damage, and patient trust erosion",
      solution: "Comprehensive HIPAA compliance testing and security validation",
    ...
    },
    {
      ...
      problem: "IoMT devices often fail to integrate seamlessly with hospital systems",
    ...
    },
    {
      ...
      impact: "Disrupted patient care and potential life-threatening situations",
    ...
    },
    {
      ...
      problem: "Healthcare sector faces 2x more cyberattacks than other industries",
    ...
    },
    {
      ...
      problem: "Medical software requires extensive validation for FDA approval",
