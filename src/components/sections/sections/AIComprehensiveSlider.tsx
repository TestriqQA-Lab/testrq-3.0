  ...
  const testingTypes = [
    {
      ...
      description:
        "Comprehensive testing of machine learning models including accuracy, precision, and performance validation.",
      features: [
        "Accuracy Testing",
        "Precision Analysis",
        "Model Performance",
    ...
    },
    {
      ...
      description:
        "Advanced bias testing to identify and mitigate unfair discrimination in AI models and ensure ethical AI.",
      features: [
        "Demographic Bias",
        "Fairness Metrics",
        "Ethical Compliance",
    ...
    },
    {
      ...
      description:
        "Advanced security testing including adversarial attacks, data poisoning, and privacy protection validation.",
      features: [
        "Adversarial Testing",
        "Data Poisoning",
        "Privacy Protection",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <button className="bg-[theme(color.brand.blue)] text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-400 transition-colors duration-300 shadow-lg transform hover:scale-105">
            Explore All AI Testing Services
          </button>
        </div>
      </div>
    </section>
