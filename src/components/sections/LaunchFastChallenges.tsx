...
const challenges = [
    ...
    },
    {
        ...
        description: "Agile demands often strain traditional QA processes. This strain leads to 'Technical Debt' and leaves gaps in coverage for both mobile and web applications.",
