...
const ETLWhyChooseTestriq: React.FC = () => {
  ...
  const advantages = [
    ...
    },
    {
      ...
      description:
        "We implement advanced security testing protocols to ensure your ETL processes meet the highest levels of data security, regulatory compliance, and access control validation, safeguarding sensitive information throughout the pipeline.",
      capabilities: [
    ...
    },
    {
      ...
      description:
        "We perform comprehensive data quality testing and validation to ensure your ETL processes deliver accurate, reliable, and business-ready data across all extraction, transformation, and loading stages.",
      capabilities: [
    ...
    },
    {
      ...
      description:
        "We conduct advanced performance testing and optimization to ensure your ETL pipelines run at peak efficiency, support high scalability, and maintain consistent data processing speed under heavy loads.",
      capabilities: [
        "Performance Testing",
        "Bottleneck Analysis",
        "Scalability Testing",
    ...
    },
    {
      ...
      description:
        "Get 24/7 support from our dedicated ETL testing specialists, equipped to handle your unique data challenges, pipeline complexities, and business-specific requirements with expert guidance and rapid issue resolution.",
      capabilities: [
        "Expert Consultation",
        "Technical Support",
        "Process Guidance",
    ...
    },
    {
      ...
      description:
        "Experience fast and efficient ETL testing processes with comprehensive reporting, quick turnaround times, and accelerated data pipeline validation for faster deployment and reduced time-to-production.",
      capabilities: [
        "Rapid Testing",
        "Quick Reports",
        "Fast Validation",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            <span className="text-brand-blue">Why Choose Testriq</span> for ETL
            Testing?
          </h2>
