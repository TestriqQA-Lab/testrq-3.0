    ...
    },
    {
      ...
      tools: [
        ...
        },
        {
          ...
          icon: <Image src="/Nmap_Logo.png" alt="Nmap Logo" width={20} height={20} className="object-contain" />,
        },
        {
          name: "Metasploit",
        ...
        },
        {
          ...
          icon: <Image src="/Artillery_Logo.png" alt="Artillery Logo" width={20} height={20} className="object-contain" />,
        },
        {
          name: "JMeter",
      ...
      tools: [
        {
          ...
          icon: <Image src="/Oscilloscopes_Logo.png" alt="Oscilloscopes Logo" width={20} height={20} className="object-contain" />,
        },
        {
          name: "RF Shield Boxes",
          description: "Isolated interference simulation",
          icon: <Image src="/RF_Shield_Boxes_Logo.png" alt="RF Shield Boxes Logo" width={20} height={20} className="object-contain" />,
        },
        {
          name: "Programmable Power",
          description: "Battery life & consumption profiling",
          icon: <Image src="/Programmable_Power_Logo.png" alt="Programmable Power Logo" width={20} height={20} className="object-contain" />,
        },
      ],
    },
  ];
