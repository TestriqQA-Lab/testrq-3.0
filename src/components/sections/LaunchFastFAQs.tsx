      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            ...
            processes, and how we can help accelerate your product launch.
          </p>
        </div>
