      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Get answers to common questions about our manual testing services, processes, and how we can help 
            ensure your software delivers exceptional quality and user experiences.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-50 to-green-50 p-8 rounded-2xl">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Our manual testing experts are here to help. Get personalized answers to your specific questions 
              and learn how our services can benefit your project.
            </p>
