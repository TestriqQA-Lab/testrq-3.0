...
const ETLFAQs: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "For real-time ETL testing, we implement continuous validation processes, streaming data quality checks, latency testing, and real-time monitoring. We use specialized tools for stream processing validation and ensure data accuracy and timeliness in real-time scenarios while maintaining system performance.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Our ETL performance testing includes throughput analysis, latency measurement, resource utilization monitoring, bottleneck identification, and scalability testing. We optimize ETL processes for maximum efficiency, validate performance under various load conditions, and provide recommendations for performance improvements and capacity planning.",
    },
  ];
