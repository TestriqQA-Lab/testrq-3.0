...
import { FaShieldAlt, FaSync, FaCheckDouble, FaBug, FaMobile, FaDesktop, FaCloud, FaHistory } from "react-icons/fa";
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6 pt-8">
              ...
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-teal-600">99.2%</div>
                <div className="text-sm text-gray-600">Stability Rate</div>
              </div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-blue-600">2,000+</div>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900">Regression Test Suite</h3>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-green-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm font-medium text-green-900">Select</div>
                ...
                <div className="bg-teal-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm font-medium text-teal-900">Execute</div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg text-center">
                  ...
                  <div className="text-sm font-medium text-blue-900">Validate</div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-green-600">1,247 Selected</div>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg">
              ...
              <div className="mb-4">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-green-600 font-medium">67% Complete</span>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-3">
                  <div className="bg-gradient-to-r from-green-600 to-teal-600 h-3 rounded-full" style={{width: '67%'}}></div>
                </div>
              </div>
