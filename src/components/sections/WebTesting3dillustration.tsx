...
const WebTesting3dillustration = () => {
    ...
    >
                    {/* Chrome */}
                    <div
      className="absolute top-0 left-1/2 -translate-x-1/2 bg-white p-1.5 rounded-full shadow-lg border border-gray-100"
    >
                    ...
                    {/* Mobile (Responsive) */}
                    <div
      className="absolute bottom-0 left-1/2 -translate-x-1/2 bg-white p-2 rounded-xl shadow-lg border border-gray-100"
    >
    ...
    >
                    {/* Firefox */}
                    <div
      className="absolute left-0 top-1/2 -translate-y-1/2 bg-white p-1.5 rounded-full shadow-lg border border-gray-100"
    >
                    ...
                    {/* Safari & Tablet Group */}
                    <div
      className="absolute right-0 top-1/2 -translate-y-1/2 flex gap-2 bg-white p-1.5 rounded-2xl shadow-lg border border-gray-100"
    >
