  ...
  const toolCategories = [
    {
      ...
      tools: [
        { name: "Session Tester", description: "Session-based test management and charter tracking" },
        { name: "Rapid Reporter", description: "Real-time note taking and session documentation" },
        { name: "TestPad", description: "Exploratory testing checklist and session management" },
        { name: "Exploratory Testing Chrome Extension", description: "Browser-based exploration tracking" }
      ]
    },
    {
      title: "Bug Tracking & Documentation",
      tools: [
        { name: "Jira", description: "Comprehensive bug tracking and project management" },
        { name: "Azure DevOps", description: "Integrated development and testing workflow" },
        { name: "Bugzilla", description: "Open-source bug tracking and reporting" },
        { name: "Linear", description: "Modern issue tracking for development teams" }
      ]
    },
    {
      title: "Screen Recording & Evidence",
      tools: [
        { name: "Loom", description: "Screen recording for bug reproduction and evidence" },
        { name: "OBS Studio", description: "Professional screen recording and streaming" },
        { name: "CloudApp", description: "Quick screen capture and annotation tools" },
        { name: "Snagit", description: "Advanced screen capture and editing capabilities" }
      ]
    },
    {
      title: "Mind Mapping & Planning",
      tools: [
        { name: "XMind", description: "Mind mapping for test planning and exploration" },
        { name: "MindMeister", description: "Collaborative mind mapping for test strategies" },
        { name: "Coggle", description: "Simple mind mapping for exploration planning" },
        { name: "FreeMind", description: "Open-source mind mapping for test design" }
      ]
    },
    {
      title: "Heuristic Evaluation Tools",
      tools: [
        { name: "Nielsen's Heuristics Checklist", description: "Usability heuristics evaluation framework" },
        { name: "WAVE", description: "Web accessibility evaluation and testing" },
        { name: "axe DevTools", description: "Accessibility testing and evaluation" },
        { name: "Lighthouse", description: "Performance and accessibility auditing" }
      ]
    },
    {
      title: "Collaboration & Communication",
      tools: [
        { name: "Slack", description: "Real-time team communication and collaboration" },
        { name: "Microsoft Teams", description: "Integrated communication and file sharing" },
        { name: "Miro", description: "Collaborative whiteboarding and planning" },
        { name: "Notion", description: "Documentation and knowledge management" }
      ]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl text-center shadow-sm">
              ...
              <div className="text-sm text-gray-600">Session-Based Test Management</div>
            </div>
            <div className="bg-white p-6 rounded-xl text-center shadow-sm">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {[
              "Session-Based Testing", "Charter-Driven Exploration", "Persona-Based Testing", 
              "Boundary Value Analysis", "Error Guessing", "Equivalence Partitioning",
              "State Transition Testing", "Use Case Testing", "Scenario-Based Testing",
              "Risk-Based Testing", "Exploratory Automation", "Crowd Testing"
            ].map((technique, index) => (
              <span key={index} className="px-4 py-2 bg-green-100 text-green-600 rounded-full text-sm font-medium">
                {technique}
              </span>
            ))}
          </div>
        ...
        <div className="mt-12 bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">
              Our toolkit is specifically designed for effective exploratory testing, ensuring systematic 
              investigation, comprehensive documentation, and actionable insights.
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Documentation Platforms</div>
              </div>
              <div className="text-center">
