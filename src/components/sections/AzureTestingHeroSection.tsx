                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="flex flex-col items-center xl:items-start text-center xl:text-left mx-auto xl:mx-0">
                        ...
                        <p className="text-gray-700 text-lg md:text-xl mb-8 max-w-2xl leading-relaxed">
                            In the hyper-scale digital landscape of 2026, Azure is more than a platform—it is the backbone of enterprise innovation. As a world-class independent QA and testing house with over <span className="text-[#0078d4] font-bold">15 years of global delivery experience</span>, Testriq provides high-impact Azure testing services engineered to secure and optimize your cloud ecosystem.
                        </p>
