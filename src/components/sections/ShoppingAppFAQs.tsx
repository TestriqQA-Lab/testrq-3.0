...
const ShoppingAppFAQs = () => {
  ...
  const faqs = [
    ...
    {
      question: "Which regulations and standards are covered in the certification?",
      answer:
    ...
    {
      question: "Can I certify a multi-region or cross-border shopping platform?",
      answer:
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Find answers about our shopping app certification services, process, timelines,
            and how we help elevate your e-commerce platform’s trust and performance.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-brand-blue to-blue-600 text-white rounded-xl p-8">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Our experts are here to guide you through the certification journey.
              Schedule a free consultation tailored to your shopping app.
            </p>
