        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col lg:flex-col xl:flex-row gap-4 pt-4">
              <button className="bg-gradient-to-r from-[theme(color.brand.blue)] to-sky-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg hover:shadow-lg hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-[theme(color.brand.blue)]">+45%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-700">Bug Reduction Rate</span>
                  <span className="font-bold text-[theme(color.brand.blue)]">-85%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-700">Performance Improvement</span>
                  <span className="font-bold text-[theme(color.brand.blue)]">+60%</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-700">App Store Rating</span>
                  <span className="font-bold text-[theme(color.brand.blue)]">4.8/5</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-20 bg-gradient-to-r from-[theme(color.brand.blue)] to-sky-600 rounded-3xl p-8 text-white text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 text-[theme(color.brand.blue)] justify-center">
              <button className="bg-white px-6 py-3 rounded-2xl font-semibold hover:bg-gray-100 hover:scale-98 transition-all">
                Get Free Game Analysis
              </button>
              <button className="bg-white bg-opacity-20 px-6 py-3 rounded-2xl font-semibold hover:bg-opacity-30 hover:scale-98 transition-all border border-white border-opacity-30">
