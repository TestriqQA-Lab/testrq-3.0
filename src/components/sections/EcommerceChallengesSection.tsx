  ...
  const challenges = [
    {
      ...
      solution: (<>ISO 29119-2 risk-based <Link href="/performance-testing-services" className="text-blue-600 hover:underline">load testing</Link> using JMeter and k6 to simulate millions of concurrent users.</>),
    ...
    },
    {
      ...
      solution: (<>Rigorous <Link href="/api-testing" className="text-orange-600 hover:underline">API integration testing</Link> and sandbox checkout validation for Stripe, PayPal, and more.</>),
    ...
    },
    {
      ...
      solution: (<>ISO 29119-4 <Link href="/mobile-application-testing" className="text-purple-600 hover:underline">mobile testing</Link> optimized for thumb-reach and visual consistency across all viewports.</>),
    ...
    },
    {
      ...
      solution: (<><Link href="/security-testing" className="text-green-600 hover:underline">PCI DSS 4.0 compliance audits</Link>, SSL validation, and mandatory MFA check penetration testing.</>),
