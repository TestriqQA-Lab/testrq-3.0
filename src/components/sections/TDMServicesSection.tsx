                    ...
                    <div className="w-full lg:w-2/3 grid grid-cols-1 gap-12">
                        {services.map((service, index) => (
                            <motion.div
                                ...
                                className="group relative flex flex-col sm:flex-row gap-6 sm:gap-8 p-6 sm:p-8 rounded-2xl hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100"
                            >
