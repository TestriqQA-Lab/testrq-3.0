...
const CaseStudySolutionSection: React.FC<CaseStudySolutionSectionProps> = ({
  caseStudy,
}) => {
  return (
        ...
        <div className="mt-16 bg-gradient-to-r from-[theme(color.brand.blue)] to-blue-600 rounded-2xl p-8 text-white">
          <div className="text-center">
            ...
            <p className="text-blue-100 text-lg max-w-4xl mx-auto leading-relaxed mb-8">
              Our comprehensive testing solution addressed all critical issues
              while establishing a foundation for long-term quality assurance
