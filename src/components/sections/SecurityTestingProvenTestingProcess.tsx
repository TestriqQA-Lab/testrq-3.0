...
import { FaShieldAlt, FaSearch, FaBug, FaFileAlt, FaCheckCircle } from "react-icons/fa";
  ...
  const processSteps = [
    {
      ...
      description: "Comprehensive security assessment planning including threat modeling, attack surface analysis, and security testing strategy definition.",
      activities: [
    ...
    },
    {
      ...
      description: "Systematic information gathering and reconnaissance to understand the target application architecture and identify potential entry points.",
      activities: [
    ...
    },
    {
      ...
      description: "Comprehensive vulnerability scanning and assessment using automated tools and manual testing techniques to identify security weaknesses.",
      activities: [
    ...
    },
    {
      ...
      duration: "5-7 days",
      icon: <FaBug className="text-2xl" />,
      description: "Ethical hacking and penetration testing to exploit identified vulnerabilities and demonstrate real-world attack scenarios.",
      activities: [
    ...
    },
    {
      ...
      description: "Comprehensive security analysis with detailed reporting, risk assessment, and actionable remediation recommendations.",
      activities: [
    ...
    },
    {
      ...
      description: "Ongoing support for vulnerability remediation with validation testing to ensure security issues are properly addressed.",
      activities: [
          ...
          {processSteps.map((step, index) => {
            ...
            return (
              <div key={step.id} className="relative">
                ...
                <div className={`${colors.bg} rounded-2xl p-8 hover:shadow-xl transition-all duration-300 relative z-10`}>
                  <div className="grid lg:grid-cols-3 gap-8 items-start">
                    ...
                    <div className="lg:col-span-1">
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        <div>
                          <div className="text-sm font-medium text-gray-500 mb-1">Step {step.id}</div>
                          <h3 className="text-xl font-bold text-gray-900">{step.title}</h3>
                        </div>
                      </div>
                      
                      <div className={`${colors.text} font-semibold text-lg mb-4`}>
                        {step.duration}
                      </div>
                      ...
                      <div className="space-y-3">
                        {step.activities.map((activity, activityIndex) => (
                          <div key={activityIndex} className="flex items-start space-x-3">
                            <div className={`${colors.accent} w-2 h-2 rounded-full mt-2 flex-shrink-0`}></div>
                    ...
                    <div className="lg:col-span-1">
                      <div className="bg-white p-6 rounded-xl border-2 border-gray-100">
                        <h4 className="text-lg font-semibold text-gray-900 mb-3">
                          {step.nextStep === "Complete" ? "Process Complete" : `Next: ${step.nextStep}`}
                        </h4>
                        ...
                        {step.nextStep === "Complete" ? (
                          <div className="space-y-3">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-sm text-gray-600">Security assessment complete</span>
                            </div>
                            <div className="flex items-center space-x-2">
                              <FaCheckCircle className="text-green-600" />
                              <span className="text-sm text-gray-600">Comprehensive security report delivered</span>
                            </div>
                            <div className="flex items-center space-x-2">
                              <FaCheckCircle className="text-green-600" />
                              <span className="text-sm text-gray-600">Ongoing security support available</span>
                            </div>
                          </div>
                        ) : (
                          <div className="space-y-3">
                            <div className="text-sm text-gray-600">
                              Upon completion of this phase, we proceed to the next step in our comprehensive security testing process.
                            </div>
        ...
        <div className="mt-16 bg-gray-100 rounded-2xl p-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Comprehensive Protection</h4>
              <p className="text-sm text-gray-600">Complete security coverage across all application layers and components</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Thorough Analysis</h4>
              <p className="text-sm text-gray-600">Deep security analysis with both automated and manual testing approaches</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 mb-2">Detailed Reporting</h4>
              <p className="text-sm text-gray-600">Comprehensive reports with actionable remediation recommendations</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Ongoing security support and validation throughout the remediation process</p>
            </div>
          </div>
        </div>
