...
const BankingComplianceSection: React.FC = () => {
  const complianceStandards = [
    {
      ...
      description: "Comprehensive security requirements for organizations handling credit card information.",
    ...
    },
    {
      ...
      requirements: ["Internal Controls", "Financial Reporting", "Audit Requirements", "Executive Certification"],
    ...
    },
    {
      ...
      description: "Data protection and privacy regulation for individuals within the European Union.",
    ...
    },
    {
      ...
      description: "Global regulatory framework for banks addressing capital adequacy and risk management.",
      requirements: ["Capital Requirements", "Liquidity Coverage", "Risk Management", "Stress Testing"],
    ...
    },
    {
      ...
      description: "Guidelines for financial institutions regarding IT examination and cybersecurity.",
      requirements: ["Cybersecurity Assessment", "IT Risk Management", "Incident Response", "Third-party Risk"],
    ...
    },
    {
      ...
      description: "Privacy rights and consumer protection for California residents.",
      requirements: ["Consumer Rights", "Data Transparency", "Opt-out Rights", "Non-discrimination"],
  ...
  const complianceProcess = [
    ...
    },
    {
      step: "2",
      title: "Planning",
      description: "Development of compliance testing strategy and implementation roadmap"
    },
    {
      step: "3",
      title: "Testing",
      description: "Execution of compliance tests and validation of regulatory requirements"
    },
    {
      step: "4",
      title: "Reporting",
    ...
    },
    {
      step: "5",
      title: "Monitoring",
      description: "Continuous monitoring and maintenance of compliance standards"
    }
  ];
      ...
      <div className="mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-[theme(color.brand.blue)] bg-opacity-10 rounded-full px-6 py-2 mb-6">
            <FaGavel className="w-4 h-4 text-[theme(color.brand.blue)]" />
            <span className="text-sm font-medium text-[theme(color.brand.blue)]">Regulatory Compliance</span>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 mb-16 shadow-lg border border-gray-100">
          <h3 className="text-2xl font-bold text-gray-900 text-center mb-8">Compliance Landscape</h3>
            ...
            >
              ...
              <div className="bg-red-100 rounded-xl p-4 mb-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold text-red-700 text-sm">NON-COMPLIANCE PENALTY:</span>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            {complianceProcess.map((process, index) => (
              <div key={index} className="text-center">
                ...
                <h4 className="text-lg font-bold mb-2 text-gray-900">{process.title}</h4>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Proactively identify and address compliance gaps before they become costly violations.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FaUsers className="w-6 h-6 text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Customer Trust</h4>
                    <p className="text-sm text-gray-600">Demonstrate your commitment to data protection and regulatory compliance to build customer confidence.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <FaChartLine className="w-6 h-6 text-green-500 mt-1 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Competitive Advantage</h4>
                    <p className="text-sm text-gray-600">Stay ahead of regulatory changes and maintain a competitive edge in the market.</p>
                  </div>
                </div>
              </div>
            </div>
