      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-white">
            <FaPhone className="w-8 h-8 mx-auto mb-4 text-blue-200" />
            <h3 className="font-semibold mb-2">Call Us</h3>
            <p className="text-blue-100 text-sm">Speak directly with our robotic testing experts</p>
          </div>
          
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-white">
            <FaEnvelope className="w-8 h-8 mx-auto mb-4 text-blue-200" />
            <h3 className="font-semibold mb-2">Email Us</h3>
            <p className="text-blue-100 text-sm">Get detailed information about our services</p>
          </div>
          
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-white">
            <FaComments className="w-8 h-8 mx-auto mb-4 text-blue-200" />
            <h3 className="font-semibold mb-2">Live Chat</h3>
            <p className="text-blue-100 text-sm">Chat with our team for immediate assistance</p>
          </div>
        </div>
