    ...
    <section className="bg-gradient-to-r from-green-50 to-blue-50 py-16 px-8 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
          Ready to Ensure Smart Device Quality?
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button className="border border-green-500 text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors duration-300">
