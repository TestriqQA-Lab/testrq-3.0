...
const CaseStudyTechnologiesSection: React.FC<CaseStudyTechnologiesSectionProps> = ({ caseStudy }) => {
  // Technology categories for better organization
  const getTechnologyCategory = (tech: string) => {
    const categories = {
      automation: ['Selenium', 'Cypress', 'Playwright', 'Appium', 'TestComplete'],
      performance: ['JMeter', 'K6', 'LoadRunner', 'Gatling', 'BlazeMeter'],
      api: ['Postman', 'REST Assured', 'SoapUI', 'Insomnia', 'Newman', 'API Testing'],
      security: ['OWASP ZAP', 'Burp Suite', 'Nessus', 'Veracode', 'Security Testing', 'Penetration Testing'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            We leveraged industry-leading tools and technologies to deliver comprehensive testing solutions 
              ...
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500 capitalize">{category} Tool</p>
                  </div>
                </div>
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div className="bg-[theme(color.brand.blue)] h-2 rounded-full" style={{ width: '85%' }}></div>
                </div>
              </div>
            );
          })}
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center">Technology Categories</h3>
        ...
        <div className="mt-16 bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 text-white">
          <div className="text-center">
            ...
            <p className="text-gray-300 text-lg max-w-4xl mx-auto leading-relaxed mb-8">
              Our carefully selected technology stack enabled us to deliver comprehensive testing coverage, 
              reduce manual effort, and achieve exceptional results in record time.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-[theme(color.brand.blue)] mb-2">80%</div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-[theme(color.brand.blue)] mb-2">99%</div>
