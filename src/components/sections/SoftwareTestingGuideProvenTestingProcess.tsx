...
const SoftwareTestingGuideProvenTestingProcess = () => {
  ...
  const processMetrics = [
    ...
    },
    {
      ...
      value: "88%",
      description: "Achieve professional certification",
    },
    {
      label: "Career Growth",
      value: "73%",
      description: "Get promoted within 6 months",
    },
    {
      label: "Satisfaction Score",
      value: "4.9/5",
      description: "Average learner rating",
    },
  ];
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-brand-blue to-blue-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              ...
              through our comprehensive testing education program.
            </p>
