  ...
  const securityFeatures = [
    {
      ...
      description: "All user communications and sensitive data are protected with military-grade encryption.",
    ...
    },
    {
      ...
      description: "Multi-layer identity verification to ensure authentic user profiles and prevent fake accounts.",
      benefits: ["Document Verification", "Biometric Checks", "Phone Verification"],
    ...
    },
    {
      ...
      description: "Multi-factor authentication and secure login mechanisms to protect user accounts.",
    ...
    },
    {
      ...
      description: "Encrypted data storage with regular backups and secure access controls.",
    ...
    },
    {
      ...
      description: "Granular privacy settings allowing users to control their information visibility.",
    ...
    },
    {
      ...
      description: "AI-powered threat detection to identify and prevent suspicious activities and scams.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive security measures designed specifically for matrimonial platforms to protect 
            sensitive personal information and ensure user safety.
          </p>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-brand-blue to-blue-600 text-white rounded-xl p-8">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Don&apos;t leave your user&apos;s sensitive information vulnerable. Get comprehensive security 
              certification that builds trust and protects your platform.
            </p>
