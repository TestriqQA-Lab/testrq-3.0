...
import { FaShieldAlt, FaPhone, FaEnvelope, FaCalendarAlt, FaCheckCircle, FaClock, FaUsers, FaCertificate } from "react-icons/fa";

const SecurityTestingReadyToEnsureQuality: React.FC = () => {
  return (
    <section className="py-16 px-8 md:px-12 lg:px-24 bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50">
      <div className="max-w-7xl mx-auto">
        {/* Main CTA Section */}
        <div className="text-center mb-16">
          <div className="bg-gradient-to-r from-red-600 to-orange-600 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-lg">
            <FaShieldAlt className="text-3xl text-white" />
          </div>
          
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
            Ready to <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-600">Secure</span> Your Applications?
          </h2>
          
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
            Partner with our expert security testing team to protect your applications from cyber threats, 
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button className="bg-gradient-to-r from-red-600 to-orange-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center space-x-2">
              <FaShieldAlt />
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Call Our Security Experts</h3>
            ...
            <div className="space-y-3">
              <div className="text-red-600 font-bold text-lg">+1 (555) 123-4567</div>
              <div className="text-gray-500 text-sm">Available 24/7 for security emergencies</div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Email Security Team</h3>
            <p className="text-gray-600 mb-6">
              Send us your security testing requirements and receive a detailed proposal with customized recommendations.
            </p>
            <div className="space-y-3">
              <div className="text-orange-600 font-bold text-lg">security@testriq.com</div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Schedule Assessment</h3>
            <p className="text-gray-600 mb-6">
            ...
            <div className="space-y-3">
              <div className="text-blue-600 font-bold text-lg">Free Consultation</div>
              <div className="text-gray-500 text-sm">30-minute security review</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Comprehensive security testing solutions that protect your applications, ensure compliance, 
              and provide peace of mind for your organization and customers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Comprehensive Protection</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-900 mb-3">Compliance Assurance</h4>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <h4 className="text-lg font-semibold text-gray-900 mb-3">Expert Team</h4>
            <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-gray-900 mb-3">Rapid Results</h4>
            <p className="text-gray-600 text-sm leading-relaxed">
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-8 md:p-12 text-white mb-16">
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Our Proven Security Testing Process</h3>
            <p className="text-gray-300 max-w-3xl mx-auto">
              Systematic approach to security testing that ensures comprehensive coverage and actionable results.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold mb-3">Assessment & Planning</h4>
              <p className="text-gray-300 text-sm">Comprehensive security assessment planning and threat modeling</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">Vulnerability assessment and penetration testing execution</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold mb-3">Reporting & Remediation</h4>
              <p className="text-gray-300 text-sm">Detailed reporting with remediation support and validation</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Don't wait for a security breach to discover vulnerabilities. Protect your applications and data 
              with comprehensive security testing from industry experts.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-gradient-to-r from-red-600 to-orange-600 text-white px-8 py-4 rounded-xl font-semibold hover:shadow-xl transition-all duration-300 transform hover:scale-105">
