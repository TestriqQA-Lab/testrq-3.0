  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-24">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-green-100 rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-semibold text-green-600">Compliance Frameworks</span>
            </div>
        ...
        {/* Technology Stack */}
        <div className="mt-20 bg-gradient-to-r from-[theme(color.brand.blue)] to-teal-600 rounded-3xl p-8 md:p-12 text-white">
          <div className="text-center mb-12">
