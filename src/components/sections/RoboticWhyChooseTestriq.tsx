...
import { FaRobot, FaShieldAlt, FaCog, FaChartLine, FaUsers, FaClock, FaAward } from "react-icons/fa";
...
const RoboticWhyChooseTestriq: React.FC = () => {
  ...
  const reasons = [
    ...
    },
    {
      ...
      description: "Advanced safety testing protocols to ensure your robotic systems meet the highest safety standards and regulations.",
    ...
    },
    {
      ...
      description: "State-of-the-art testing equipment and methodologies to validate robotic precision and performance.",
    ...
    },
    {
      ...
      description: "Comprehensive performance analysis and optimization to ensure your robots operate at peak efficiency.",
    ...
    },
    {
      ...
      description: "24/7 support from our robotic testing specialists who understand your unique robotic challenges.",
    ...
    },
    {
      ...
      description: "Fast and efficient robotic testing processes with comprehensive reporting and quick turnaround times.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Why Choose Testriq for <span className="text-brand-blue">Robotic Testing</span>?
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            We combine robotic expertise with testing excellence to deliver robotic testing services 
            that ensure reliable, safe, and high-performance robotic systems for your applications.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-lg">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Robotic Testing Excellence Network</h3>
            <p className="text-gray-600">Robotic systems and technologies we&apos;ve successfully validated</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-green-500 mb-2">99.2%</div>
              <div className="text-gray-600">Safety Rate</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-500 mb-2">±0.1mm</div>
              <div className="text-gray-600">Precision</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-orange-500 mb-2">72hr</div>
        ...
        <div className="text-center mt-12">
          <div className="mb-4">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Ready to Validate Robotic Excellence?</h3>
            <p className="text-gray-600">Join 200+ companies who trust our robotic testing expertise. Get started with a comprehensive robotic system assessment and ensure your robots are reliable and safe.</p>
          </div>
