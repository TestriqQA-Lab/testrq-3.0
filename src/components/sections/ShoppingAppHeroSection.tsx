  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-50 via-white to-blue-50 py-16 px-8 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Ensure your e-commerce platform meets the highest standards of security, performance, 
            and user experience. Get certified with comprehensive testing that builds customer trust 
            and protects sensitive shopping data.
          </p>
        </motion.div>
        ...
        >
          <p className="text-gray-600 max-w-2xl mx-auto text-md">
            Join 400+ e-commerce platforms that trust Testriq for comprehensive certification services. 
            From mobile shopping apps to enterprise e-commerce solutions, we ensure your platform meets 
            industry standards and delivers exceptional shopping experiences.
          </p>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="absolute top-1/4 left-10 w-16 h-16 bg-gradient-to-r from-brand-blue to-green-600 rounded-lg opacity-20 hidden lg:block"
      ></motion.div>
      ...
      <motion.div
        ...
        className="absolute bottom-1/4 left-1/4 w-8 h-8 bg-gradient-to-r from-orange-500 to-red-500 rounded-lg opacity-20 hidden lg:block"
      ></motion.div>
    </section>
  );
};
