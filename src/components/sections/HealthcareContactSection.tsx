  ...
  const contactOptions = [
    {
      ...
      description: "Book a free 30-minute consultation with our healthcare testing experts",
      action: "Schedule Now",
    ...
    },
    {
      ...
      description: "Get immediate answers from our healthcare compliance specialists",
      action: "Call Now",
    ...
    },
    {
      ...
      description: "Get a detailed proposal and quote for your healthcare testing needs",
      action: "Get Quote",
      ...
      <div className="mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl">
            <div className="mb-8">
              <h3 className="text-3xl font-bold text-gray-900 mb-4">Get Your Free Healthcare Testing Assessment</h3>
              <p className="text-gray-600">Fill out this form and our healthcare testing experts will contact you within 24 hours.</p>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Healthcare Software Type *</label>
                <select className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[theme(color.brand.blue)] focus:border-transparent outline-none transition-all">
                  ...
                  <option value="clinical-decision">Clinical Decision Support</option>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <label className="flex items-center">
                    ...
                    <span className="ml-2 text-gray-700">HIPAA Compliance Testing</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" className="rounded border-gray-300 text-[theme(color.brand.blue)] focus:ring-[theme(color.brand.blue)]" />
                    <span className="ml-2 text-gray-700">FDA Validation Support</span>
                  </label>
                  <label className="flex items-center">
                    <input type="checkbox" className="rounded border-gray-300 text-[theme(color.brand.blue)] focus:ring-[theme(color.brand.blue)]" />
                  ...
                  <label className="flex items-center">
                    <input type="checkbox" className="rounded border-gray-300 text-[theme(color.brand.blue)] focus:ring-[theme(color.brand.blue)]" />
                    <span className="ml-2 text-gray-700">Interoperability Testing</span>
                  </label>
                </div>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Our Healthcare Expertise</h3>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Healthcare Hotline</div>
                    <div className="text-gray-600">+1 (555) 123-HEALTH</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Healthcare Team</div>
                    <div className="text-gray-600">healthcare@testriq.com</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
