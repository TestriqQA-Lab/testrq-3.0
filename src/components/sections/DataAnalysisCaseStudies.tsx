...
const DataAnalysisCaseStudies = () => {
  ...
  const caseStudies = [
    {
      ...
      industry: "E-commerce",
      challenge:
        "Optimizing product recommendations and inventory management across global markets with real-time demand forecasting",
      solution:
        "Implemented machine learning-based recommendation engine and predictive analytics for inventory optimization",
      results: [
    ...
    },
    {
      ...
      challenge:
        "Personalizing content recommendations for 230M+ subscribers across diverse global markets and preferences",
      solution:
        "Developed advanced collaborative filtering and deep learning models for content personalization",
      results: [
    ...
    },
    {
      ...
      challenge:
        "Real-time fraud detection and risk assessment for millions of daily transactions with regulatory compliance",
      solution:
        "Built comprehensive fraud detection system using ensemble machine learning and real-time analytics",
      results: [
    ...
    },
    {
      ...
      challenge:
        "Dynamic pricing optimization and demand prediction across 10,000+ cities with real-time market conditions",
      solution:
        "Implemented surge pricing algorithms and demand forecasting models using real-time data analytics",
      results: [
  ...
  const industries = [
    { name: "E-commerce", projects: "28+", growth: "+35%" },
    { name: "Finance", projects: "30+", growth: "+42%" },
    { name: "Healthcare", projects: "26+", growth: "+28%" },
    { name: "Technology", projects: "32+", growth: "+38%" },
    { name: "Retail", projects: "26+", growth: "+31%" },
    { name: "Manufacturing", projects: "28+", growth: "+26%" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Discover how industry leaders have transformed their business
            outcomes through our advanced data analysis services, leveraging
            predictive analytics, business intelligence, and data-driven
            strategies to achieve measurable results and drive strategic
            decisions.
          </p>
        </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <div>
                    <div className="text-lg font-bold text-purple-600">
                      {caseStudies[activeCase].metrics.dataProcessed}
                    </div>
                    <div className="text-xs text-gray-500">Data Processed</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-purple-600">
                      {caseStudies[activeCase].metrics.modelsDeployed}
                    </div>
                    <div className="text-xs text-gray-500">Models Deployed</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-purple-600">
                      {caseStudies[activeCase].metrics.accuracy}
                    </div>
        ...
        <div className="bg-gradient-to-r from-brand-blue to-blue-600 rounded-2xl p-8 mb-16">
          <div className="text-center text-white mb-8">
            ...
            <p className="text-purple-100 max-w-2xl mx-auto">
              Proven track record of delivering measurable business value
              through advanced data analytics and machine learning solutions.
            </p>
          </div>
        ...
        <div className="text-center">
          <div className="bg-gray-50 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Join the ranks of industry leaders who have unlocked the power of
              their data through our advanced analytics solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact-us">
                <button className="bg-brand-blue cursor-pointer text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition-colors inline-flex items-center justify-center">
                  Start Your Analytics Journey
                  <FaArrowRight className="ml-2 h-5 w-5" />
                </button>
              </Link>
              <Link href="/case-studies">
            <button className="border-2 cursor-pointer border-brand-blue text-brand-blue px-8 py-3 rounded-lg font-semibold hover:bg-brand-blue hover:text-white transition-colors">
                View Our Portfolio
              </button>
            </Link>
            </div>
