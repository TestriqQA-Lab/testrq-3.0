  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Master Selenium WebDriver with our comprehensive guide covering setup, best practices, advanced techniques, and real-world examples for web application testing.",
    ...
    },
    {
      ...
      excerpt:
        "Learn how to conduct effective performance testing using Apache JMeter, including test planning, execution, and result analysis for optimal application performance.",
    ...
    },
    {
      ...
      excerpt:
        "Comprehensive guide to mobile app security testing covering OWASP Mobile Top 10, penetration testing techniques, and security best practices.",
    ...
    },
    {
      ...
      excerpt:
        "Master API testing with Postman including collection creation, environment variables, automated testing, and CI/CD integration for robust API validation.",
    ...
    },
    {
      ...
      excerpt:
        "Ensure your web applications work flawlessly across all browsers with our comprehensive cross-browser testing strategies and tools comparison.",
    ...
    },
    {
      ...
      excerpt:
        "Detailed comparison of Cypress and Playwright for end-to-end testing, covering features, performance, ecosystem, and use case recommendations.",
      category: "Test Automation",
      categoryColor: "from-blue-500 to-blue-600",
      author: "Lisa Wang",
      authorImage: "/api/placeholder/40/40",
    ...
    },
    {
      ...
      excerpt:
        "Learn effective cloud testing strategies for major cloud platforms including infrastructure testing, scalability testing, and cost optimization.",
    ...
    },
    {
      ...
      excerpt:
        "Comprehensive guide to test data management including data generation, masking, provisioning, and compliance considerations for effective testing.",
    ...
    },
    {
      ...
      excerpt:
        "Learn how to conduct thorough accessibility testing to ensure your web applications are usable by everyone, including users with disabilities.",
