...
import { FaDatabase, FaChartLine, FaCloudUploadAlt, FaChevronLeft, FaChevronRight } from "react-icons/fa";
  ...
  const caseStudies = [
    {
      ...
      solution: "Comprehensive ETL testing for real-time financial data processing with regulatory compliance validation and risk management integration.",
      metrics: [
      ...
      testimonial: "Testriq's ETL testing ensured our financial data pipelines meet strict regulatory requirements while maintaining real-time performance.",
    ...
    },
    {
      ...
      solution: "End-to-end ETL testing for complex retail data integration from multiple sources including POS, inventory, and customer data systems.",
      metrics: [
        { label: "Data Integration", value: "15 sources unified", progress: 100 },
      ...
      testimonial: "The comprehensive ETL testing approach transformed our data integration capabilities and accelerated our analytics insights significantly.",
    ...
    },
    {
      ...
      solution: "Secure ETL testing for healthcare data migration with HIPAA compliance validation and patient data protection protocols.",
      metrics: [
      ...
      testimonial: "Testriq's expertise in healthcare ETL testing ensured our data migration was secure, compliant, and completed ahead of schedule.",
