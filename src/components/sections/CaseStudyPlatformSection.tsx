...
const CaseStudyPlatformSection: React.FC<CaseStudyPlatformSectionProps> = ({
  caseStudy,
}) => {
  ...
  const platformFeatures = [
    ...
    },
    {
      ...
      description:
        "Access to over a million photographs, graphics and fonts, aimed at mainstream users who don't consider themselves designers, as well as professionals who want to collaborate with clients.",
    },
    {
      icon: FaFont,
      title: "Smart Text Features",
      description:
        "Text dynamically resizes as you type and automatically changes from black to white as you experiment with different backgrounds. Grid lines help users figure out center and margins.",
    },
  ];
  ...
  const platformSupport = [
    {
      ...
      description:
        "Full-featured experience on PC with comprehensive design tools and advanced functionality.",
    },
    {
      icon: FaMobile,
      title: "Mobile Browsers",
      description:
        "Optimized mobile web experience for on-the-go design creation and editing.",
    },
    {
      icon: FaTabletAlt,
      title: "Native Apps",
      description:
        "Dedicated iOS and Android applications with platform-specific optimizations for tablets and mobile devices.",
    },
  ];

  return (
    <section className="py-16 px-8 md:px-12 lg:px-24 bg-gradient-to-br from-blue-50 to-indigo-50">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gray-700 leading-relaxed mb-6">
                Canva offers an easy to use drag-and-drop interface; it&apos;s
              ...
              <p className="text-gray-700 leading-relaxed">
                Other options let you quickly add backgrounds, choose from
                premade layouts, add text or even your own uploaded work. And
                there are a number of little things that Canva does that make it
                easy on end users who aren&apos;t design savvy.
              </p>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">
                    Automatically proportionally resizes images when dropped
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[theme(color.brand.blue)] rounded-full"></div>
                  <span className="text-gray-700">
                    Prevents users from accidentally stretching images out of
                    proportion
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[theme(color.brand.blue)] rounded-full"></div>
                  <span className="text-gray-700">
                    Text dynamically resizes as you type
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-[theme(color.brand.blue)] rounded-full"></div>
                  <span className="text-gray-700">
                    Shows grid lines to help with alignment and positioning
                  </span>
                </div>
              </div>
            </div>
