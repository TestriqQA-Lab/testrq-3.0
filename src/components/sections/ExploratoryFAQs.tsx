...
const ExploratoryFAQs: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Our testers are ISTQB-certified with expertise in session-based testing, heuristic evaluation, and risk-based investigation. They have 5+ years of experience across web, mobile, API, and UX testing, with deep knowledge of tools like Jira, TestPad, and accessibility frameworks. Their creative and analytical skills ensure thorough exploration and actionable insights.",
    },
    {
      question:
        "How long does an exploratory testing engagement typically take?",
      answer:
        "An exploratory testing engagement typically lasts 1-4 weeks, depending on application complexity. Individual sessions are 2-4 hours, with daily or weekly cycles for agile projects. For urgent needs, we offer same-day exploration with rapid reporting, completing targeted sessions in 4-8 hours.",
    },
    {
      question: "What deliverables do you provide after exploratory testing?",
      answer:
        "Deliverables include detailed bug reports, session logs, UX improvement recommendations, coverage reports, and risk assessments. We provide visual evidence (screenshots/videos), prioritized issue lists, and actionable insights in formats compatible with Jira, Azure DevOps, or Linear, tailored to your team’s needs.",
    },
    {
