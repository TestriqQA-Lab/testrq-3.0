...
import { SiNintendoswitch, SiUnity, SiUnrealengine, SiOculus } from "react-icons/si";
  ...
  const platforms = [
    {
      icon: FaMobile,
      title: "Mobile Gaming",
      description: "Comprehensive testing for iOS and Android mobile games",
      platforms: ["iOS (iPhone/iPad)", "Android Phones/Tablets", "Cross-Platform Mobile"],
      features: [
    ...
    },
    {
      icon: FaDesktop,
      title: "PC Gaming",
      description: "Desktop gaming testing across Windows, Mac, and Linux",
    ...
    },
    {
      ...
      platforms: ["Oculus Quest/Rift", "HTC Vive", "PlayStation VR", "ARKit/ARCore"],
      features: [
        "Motion Tracking",
        "Comfort Testing",
        "Spatial Audio",
  ...
  const gameEngines = [
    {
      icon: SiUnity,
      name: "Unity",
      description: "Comprehensive Unity game testing and optimization",
      ...
      <div className="max-w-7xl mx-auto px-8 md:px-12 lg:px-24">
          ...
          {platforms.map((platform, index) => (
            <div key={index} className="bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group border border-gray-100 hover:border-[theme(color.brand.blue)] hover:border-opacity-30">
              ...
              <div className="p-8">
                {/* Supported Platforms */}
                <div className="mb-6">
                  <h4 className="text-lg font-bold text-gray-900 mb-3">Supported Platforms</h4>
                  <div className="flex flex-wrap gap-2">
                    {platform.platforms.map((platformName, platformIndex) => (
                      <span key={platformIndex} className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-medium">
                        {platformName}
                      </span>
                    ))}
                  </div>
                ...
                {/* Features */}
                <div className="mb-6">
                  <h4 className="text-lg font-bold text-gray-900 mb-3">Testing Features</h4>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center p-3 bg-gray-50 rounded-xl">
                    <div className="text-lg font-bold text-gray-900">{platform.stats.devices}</div>
                    <div className="text-xs text-gray-600">Test Devices</div>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-xl">
                    <div className="text-lg font-bold text-gray-900">{platform.stats.coverage}</div>
                    <div className="text-xs text-gray-600">Coverage</div>
                  </div>
                  <div className="text-center p-3 bg-gray-50 rounded-xl">
                    <div className="text-lg font-bold text-gray-900">{platform.stats.platforms}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {gameEngines.map((engine, index) => (
              <div key={index} className="text-center p-8 bg-white rounded-3xl shadow-lg ring-1 ring-brand-blue hover:ring-3 hover:shadow-xl transition-all duration-300">
                ...
                <h4 className="text-xl font-bold text-gray-900 mb-3">{engine.name}</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Platform Certification</h3>
            <p className="text-gray-600">Expert guidance through platform certification processes for console and mobile app stores.</p>
          </div>
          ...
          <div className="text-center p-8 bg-gradient-to-br from-green-50 to-teal-50 rounded-3xl">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-4">Optimized Performance</h3>
            <p className="text-gray-600">Platform-specific optimization to ensure your game runs perfectly on every target device.</p>
          </div>
          ...
          <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl">
            ...
            <p className="text-gray-600">Seamless cross-platform gameplay and data synchronization testing and validation.</p>
          </div>
        </div>
