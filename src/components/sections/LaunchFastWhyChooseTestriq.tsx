...
import { FaBolt, FaRocket, FaShieldAlt, FaUsers, FaChartLine, FaClock } from "react-icons/fa";
  ...
  const advantages = [
    {
      ...
      color: "blue",
      description: "Lightning-fast testing cycles designed for agile development teams who need quality without delays.",
      capabilities: [
    ...
    },
    {
      ...
      color: "green",
      description: "Accelerate your time-to-market with optimized testing processes and agile methodologies.",
      capabilities: [
        "MVP validation",
    ...
    },
    {
      ...
      color: "purple",
      description: "Comprehensive quality assurance that ensures your product meets the highest standards at launch.",
      capabilities: [
        "Risk-based testing",
    ...
    },
    {
      ...
      color: "orange",
      description: "Seamless integration with your development team and agile processes for maximum efficiency.",
      capabilities: [
        "Scrum integration",
        "Daily standups",
        "Sprint planning",
    ...
    },
    {
      ...
      color: "teal",
      description: "Testing solutions that scale with your growth from MVP to enterprise-level applications.",
      capabilities: [
    ...
    },
    {
      ...
      color: "indigo",
      description: "Continuous testing optimization and real-time insights for sustained product excellence.",
      capabilities: [
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            <span className="text-brand-blue">Why Choose Testriq</span> for LaunchFast QA?
          </h2>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            We combine rapid testing expertise with agile methodologies to deliver LaunchFast QA services 
            that accelerate your time-to-market while ensuring exceptional quality and reliability.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="text-right">
                  <div className={`text-2xl font-bold ${hoveredCard === advantage.id ? "text-white" : "text-gray-900"}`}>
                    {advantage.metric}
                  </div>
                </div>
              </div>
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-8">
              Rapid testing methodologies and technologies we&apos;ve successfully implemented
            </p>
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-gray-600 mb-6">
            Join 300+ startups who trust our LaunchFast QA expertise. Get started with rapid testing 
            cycles and ensure your product launches successfully and on time.
          </p>
