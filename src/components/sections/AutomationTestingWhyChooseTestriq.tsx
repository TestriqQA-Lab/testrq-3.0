  ...
  const advantages = [
    {
      ...
      description:
        "Reduce testing time by 80% and boost test coverage with Testriq’s intelligent automation strategies, ensuring faster releases and high software reliability.",
    ...
    },
    {
      ...
      description:
        "Custom-built, scalable automation frameworks engineered for high maintainability, test reusability, and seamless integration into your CI/CD pipelines and agile development workflows.",
    ...
    },
    {
      ...
      description:
        "Self-healing automation scripts with intelligent error handling and recovery mechanisms deliver consistent, reliable, and resilient test execution across your software applications and CI/CD pipelines.",
    ...
    },
    {
      ...
      description:
        "Detailed ROI tracking and metrics to demonstrate the value and impact of automation on your development and testing processes.",
    ...
    },
    {
      ...
      description:
        "Round-the-clock monitoring and support for your automation infrastructure, ensuring continuous testing and rapid issue resolution.",
        ...
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-8 mb-16">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
              Our Automation Testing Success Metrics
            </h3>
            <p className="text-gray-600 max-w-3xl mx-auto">
              Proven track record of delivering exceptional automation testing
              results across diverse technologies and industries.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Our automation engineers stay at the forefront of testing
              technology, continuously adopting new tools and methodologies to
              deliver the most effective automation solutions for your projects.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Following established automation patterns and methodologies
                    for optimal results
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Frameworks designed to grow with your application and
                    testing needs
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Regular optimization and enhancement of automation
