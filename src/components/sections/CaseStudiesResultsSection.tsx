...
import { FaChartLine, FaShieldAlt, FaClock, FaDollarSign, FaUsers, FaRocket, FaBug, FaCheckCircle } from "react-icons/fa";
  ...
  const keyResults = [
    {
      ...
      title: "Bug Reduction",
      value: "99%",
      description: "Average bug reduction across all projects through comprehensive testing protocols",
      details: [
    ...
    },
    {
      ...
      value: "75%",
      description: "Faster deployment cycles through automated testing and streamlined processes",
      details: [
    ...
    },
    {
      ...
      title: "Cost Savings",
      value: "60%",
      description: "Reduced maintenance and support costs through proactive quality assurance",
      details: [
    ...
    },
    {
      ...
      value: "95%",
      description: "Improved user experience and satisfaction through quality-focused testing",
      details: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
            Data-Driven{" "}
            <span className="text-[theme(color.brand.blue)]">Success Metrics</span>
          </h2>
          <p className="text-gray-700 text-lg max-w-3xl mx-auto">
            Our success is measured in concrete results. These metrics represent real improvements 
            achieved across hundreds of projects and satisfied clients worldwide.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {keyResults.map((result, index) => {
            ...
            return (
              ...
              >
                <div className={`w-16 h-16 rounded-lg bg-gradient-to-br ${getColorClasses(result.color)} flex items-center justify-center mb-6`}>
        ...
        <div className="bg-gradient-to-r from-brand-blue to-sky-600 rounded-xl p-8 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-200 text-xs">Typical investment recovery</p>
            </div>
          </div>
