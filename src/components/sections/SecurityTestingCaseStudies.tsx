...
const SecurityTestingCaseStudies: React.FC = () => {
  ...
  const caseStudies = [
    {
      ...
      challenge: "A leading international bank needed comprehensive security testing for their new digital banking platform to ensure compliance with PCI DSS and protect against sophisticated cyber threats targeting financial institutions.",
      solution: "Conducted extensive penetration testing, vulnerability assessment, and compliance validation covering web applications, mobile apps, APIs, and backend infrastructure. Implemented advanced threat modeling and red team exercises.",
      results: [
      ...
      technologies: ["Web Application Testing", "API Security", "Mobile Security", "Network Penetration Testing"],
      timeline: "8 weeks",
    ...
    },
    {
      ...
      challenge: "A healthcare network managing sensitive patient data across multiple facilities required comprehensive security testing to ensure HIPAA compliance and protect against healthcare-targeted ransomware attacks.",
      solution: "Performed thorough security assessment including vulnerability scanning, penetration testing, and compliance validation. Implemented specialized healthcare security controls and data encryption validation.",
      results: [
      ...
      technologies: ["HIPAA Compliance Testing", "Data Encryption Validation", "Access Control Testing", "Threat Modeling"],
      timeline: "10 weeks",
    ...
    },
    {
      ...
      challenge: "A major e-commerce platform processing millions of transactions daily needed comprehensive security testing to protect customer payment data and prevent fraud while maintaining high performance.",
      solution: "Conducted extensive web application security testing, payment processing validation, and fraud prevention system assessment. Implemented continuous security monitoring and automated vulnerability scanning.",
      results: [
      ...
      technologies: ["Payment Security Testing", "Fraud Prevention", "Web Application Security", "Continuous Monitoring"],
      timeline: "12 weeks",
    ...
    },
    {
      ...
      challenge: "A state university system with multiple campuses needed comprehensive security assessment to protect student data, research information, and academic systems from increasing cyber threats targeting educational institutions.",
      solution: "Performed campus-wide security assessment including network penetration testing, web application security, email security, and student information system validation. Implemented security awareness training and incident response procedures.",
      results: [
      ...
      technologies: ["Network Security", "Student Information Systems", "Research Data Protection", "Security Training"],
      timeline: "14 weeks",
  ...
  const getColorClasses = (color: string) => {
    const colorMap: { [key: string]: { bg: string; text: string; accent: string; border: string } } = {
      blue: { bg: "bg-blue-50", text: "text-blue-600", accent: "bg-blue-600", border: "border-blue-200" },
      red: { bg: "bg-red-50", text: "text-red-600", accent: "bg-red-600", border: "border-red-200" },
      green: { bg: "bg-green-50", text: "text-green-600", accent: "bg-green-600", border: "border-green-200" },
      purple: { bg: "bg-purple-50", text: "text-purple-600", accent: "bg-purple-600", border: "border-purple-200" }
    };
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-4 mb-6">
                <div className={`${colors.accent} w-16 h-16 rounded-2xl flex items-center justify-center`}>
                  <span className="text-white">{currentCaseStudy.icon}</span>
                </div>
                <div>
                  <div className="text-sm font-medium text-gray-500 mb-1">{currentCaseStudy.industry}</div>
                  <h3 className="text-xl font-bold text-gray-900">{currentCaseStudy.client}</h3>
                </div>
              </div>

              <h4 className="text-2xl font-bold text-gray-900 mb-4">{currentCaseStudy.title}</h4>

              <div className="space-y-4 mb-6">
                <div className="flex items-center space-x-3">
                  <span className="text-gray-500 font-medium">Timeline:</span>
                  <span className={`${colors.text} font-semibold`}>{currentCaseStudy.timeline}</span>
                </div>
                <div className="flex items-center space-x-3">
                  <span className="text-gray-500 font-medium">Team Size:</span>
                  <span className={`${colors.text} font-semibold`}>{currentCaseStudy.teamSize}</span>
                </div>
              </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* Results */}
              <div>
                <h5 className="text-lg font-semibold text-gray-900 mb-4">Results & Impact</h5>
                <div className="grid md:grid-cols-2 gap-4">
                  {currentCaseStudy.results.map((result, index) => (
                    <div key={index} className="bg-white p-4 rounded-xl shadow-sm">
                      <div className="flex items-start space-x-3">
                        <div className={`${colors.accent} w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5`}>
        ...
        <div className="mt-16 bg-gray-100 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600 font-medium">Critical Issues Identified</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">100%</div>
              <div className="text-gray-600 font-medium">Compliance Success Rate</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center p-6 bg-blue-50 rounded-xl">
            ...
            <p className="text-sm text-gray-600">Banking, insurance, and fintech security testing</p>
          </div>
          ...
          <div className="text-center p-6 bg-red-50 rounded-xl">
            ...
            <p className="text-sm text-gray-600">HIPAA compliance and patient data protection</p>
          </div>
          ...
          <div className="text-center p-6 bg-green-50 rounded-xl">
            ...
            <p className="text-sm text-gray-600">Payment security and fraud prevention</p>
          </div>
          ...
          <div className="text-center p-6 bg-purple-50 rounded-xl">
            ...
            <p className="text-sm text-gray-600">Student data protection and research security</p>
          </div>
        </div>
